...
import img1 from "../../assets/images/sect2.jpg";
import img2 from "../../assets/images/sec3.jpg";
import img3 from "../../assets/images/sec4.jpg";
import img4 from "../../assets/images/sec5.jpg";
import img5 from "../../assets/images/sec6.jpg";
import img6 from "../../assets/images/sec7.jpg";
import img7 from "../../assets/images/sec8.jpg";
  ...
  <div>
    <div className="mt-16 first:mt-0">
      ...
      <div className="inline-block border border-[black] font-lato text-xs px-7 py-3  mt-4 mb-10 md:mt-7 md:px-9 md:mb-14 hover:text-[#fff] hover:bg-[#cb8161]">
        <Link to="/" className="w-full h-full tracking-widest">
          READ MORE
        </Link>
      </div>
    </div>
