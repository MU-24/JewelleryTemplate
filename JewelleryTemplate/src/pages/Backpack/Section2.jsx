...
const Section2 = () => {
  return (
    <div className="mb-56">
      <div>
        <h2 className="font-serif text-xl font-medium tracking-wide">SEARCH</h2>
      ...
      <div className="mt-14">
        ...
        <ul className="font-lato text-sm">
          <li className="flex items-center mt-4">
            ...
            <Link to="" className="text-[#868686] hover:text-[#ff6900]">
              Backpack (8)
            </Link>
          </li>
      ...
      <div className="mt-14">
        <h2 className="font-serif text-xl font-semibold tracking-wide">TAGS</h2>
        <div className="mt-8">
